...
const TREE_DEFS = [
  ...
  },
  {
    ...
    pool: [
      ...
      { id: 'd_03', name: 'Rapid Scramble',    icon: PERK_ICONS['Rapid Scramble'],    desc: 'Destroyers launch 30% faster from Destroyer Factories.', tested: true },
      { id: 'd_04', name: 'Hunter Protocol',   icon: PERK_ICONS['Hunter Protocol'],   desc: 'Each Destroyer deals +2 damage against Dreadnaughts and Flagships.', tested: true },
      { id: 'd_05', name: 'Torpedo Spread',    icon: PERK_ICONS['Torpedo Spread'],    desc: 'Each Destroyer Pre-Strike can hit non-Fighter ships for 15 damage.', tested: true },
      { id: 'd_06', name: 'Last Stand',        icon: PERK_ICONS['Last Stand'],        desc: 'Each Destroyer deals +2 damage when their stack is outnumbered.', tested: true },
  ...
  },
  {
    ...
    pool: [
      ...
      { id: 'dr_08', name: 'Rapid Scramble',  icon: PERK_ICONS['Rapid Scramble'],  desc: 'Dreadnaughts launch 30% faster from Dreadnaught Factories.', tested: true },
      { id: 'dr_09', name: 'First Strike',    icon: PERK_ICONS['First Strike'],    desc: 'Each Dreadnaught gains a Pre-Strike hit of 5 damage.', tested: true },
